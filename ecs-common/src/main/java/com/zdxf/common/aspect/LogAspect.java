package com.zdxf.common.aspect;
...
public class LogAspect {
     ...
     *     配置织入点
      */
    @Pointcut("@annotation(com.zdxf.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            getControllerMethodDescription(joinPoint,null);
//            // *========数据库日志=========*//
...
//            AsyncManager.me().execute(AsyncFactory.recordOper(operLog));
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log/*OperLog operLog*/) throws Exception {
        System.out.println("person annotion test ");
//        // 设置action动作
